...
export const organizationFeatureFlags = pgTable("organization_feature_flags", {
  ...
  index("organization_feature_flags_feature_flag_id_idx").on(table.featureFlagId),
  uniqueIndex("organization_feature_flags_organization_flag_unique").on(table.organizationId, table.featureFlagId),
]);
